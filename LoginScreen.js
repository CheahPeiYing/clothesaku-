...
import ClothesakuIcon from './images/clothesaku_logo.png';
    ...
    return (
      <View style={styles.container}>
        <Image
          ...
          style={{height:Dimensions.get('window').width - 150 , width: Dimensions.get('window').width - 120 }}
        />

        <View style={{height: 20}}></View>

        <View style={{width: 250, borderRadius: 5, backgroundColor:'transparent', padding: 35, justifyContent:'center', alignItems: 'center'}}>
          <TextInput
            underlineColorAndroid="transparent"
            autoCapitalize="sentences"
            autoCorrect={true}
            style={{width: 240, backgroundColor: "#F4F4F4", opacity: 0.4, height: 40}}
          ...
          <TouchableHighlight
            ...
            onPress={() =>{
              ...
              if(checkIndexExist < 0){
                ...
                alert('Email and username does not match ')
              }

            }}
          >

            <View style={{justifyContent: 'center', alignItems: 'center',height: 40, width: 140, backgroundColor: '#F4F4F4', borderRadius: 15}}>
